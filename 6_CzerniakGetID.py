...
def find_gene_id(gene_symbol):
    ...
    url = f'https://www.ncbi.nlm.nih.gov/gene/?term=({gene_symbol}+%5BGene+Name%5D)+AND+Homo+sapiens%5BOrganism%5D'
    ...
    gene_id_element = soup.find('span', {'class': 'geneid'})
    if gene_id_element is not None:
        gene_id = gene_id_element.text.split(': ')[1].split(',')[0]
...
if __name__ == '__main__':
    ...
    output_folder_path = 'data/Czerniak/GeneListID'
